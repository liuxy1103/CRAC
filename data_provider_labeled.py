	...
	def __init__(self, cfg):
		...
		if cfg.DATA.dataset_name == 'cremi-A' or cfg.DATA.dataset_name == 'cremi':
			...
			if cfg.DATA.if_sparse:
				if cfg.DATA.sparse_id == 1:
					self.train_labels = ['cremiC_labels1.h5']
				elif cfg.DATA.sparse_id == 3:
					self.train_labels = ['cremiC_labels3.h5']
				elif cfg.DATA.sparse_id == 5:
					self.train_labels = ['cremiC_labels5.h5']
				elif cfg.DATA.sparse_id == 10:
					self.train_labels = ['cremiC_labels10.h5']
				else:
			...
			if cfg.DATA.if_sparse:
				if cfg.DATA.sparse_id == 1:
					self.train_labels = ['AC3_labels1.h5']
				elif cfg.DATA.sparse_id == 5:
				...
				elif cfg.DATA.sparse_id == 50:
					self.train_labels = ['AC3_labels50.h5']
				elif cfg.DATA.sparse_id == 0:
			...
			# 		self.train_labels = ['AC3_labels_5s.h5']
			# elif cfg.DATA.mode==1:
			# 	if cfg.DATA.sparse_id == 5:
			# 		self.train_labels = ['AC3_labels_5b.h5']
	...
	def __getitem__(self, index):
		...
		if self.shift_channels is None:
			...
			if self.output_nc == 3:
				...
				label233 = seg_to_aff(lb, nhood233, pad='',if_bg=if_bg)
				label399 = seg_to_aff(lb, nhood399, pad='',if_bg=if_bg)
				label427 = seg_to_aff(lb, nhood427, pad='',if_bg=if_bg)
