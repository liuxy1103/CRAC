...
from utils.affinity_official_simple import gen_affs_official
	...
	def __getitem__(self, index):
		...
		if self.shift_channels is None:
			if self.output_nc == 3:
				...
				shifts = [[-1,0,0],[0,-1,0],[0,0,-1],[0,0,-2],[-5,0,0],[0,-5,0],[-5,-5,0],[-5,5,0],[-5,0,-1],[0,-5,-1],[-5,0,1],[0,-5,1]]
				lb_affs = gen_affs_official(lb, offsets=shifts).astype(np.float32)
			else:
		...
		return imgs, lb_affs,weightmap, lb
